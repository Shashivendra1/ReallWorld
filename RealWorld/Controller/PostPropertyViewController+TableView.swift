//
//  PostPropertyViewController+TableView.swift
//  ReallWorld
//
//  Created by shashivendra sengar on 18/09/22.
...
extension PostPropertyViewController : UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = searchTableView.dequeueReusableCell(withIdentifier: "PostPropertyViewTableViewCell", for: indexPath) as! PostPropertyViewTableViewCell
...
extension PostPropertyViewController: UISearchBarDelegate {
